...
public class LoopApp {
	...
	public static void main(String[] args) {
		...
		//for문(반복의 시작값 정의; 반복의 종료값 정의; 반복할때 증가하는 값) {반복할때 구현내용}
		...
		//향상된 for문, 스프링 jsp에서 제일많이 사용하게 될 구문.
		String[] names = {"사용자1","사용자2","사용자3","사용자4","사용자5"};
		//int length = names.length;//length 기본형 변수에는 5가 들어가게됩니다.
		//names는 클래스형 변수지만, 인스턴스는 아닙니다.
		char name = '사';//임베디드장비와 자바프로그램 통신시 이것을 사용함.
		//임베디드 프로그램에서 char을 사용하는 이유는 메모리를 효율적으로 사용하기 위해서 char을 사용함.
		...
		//배열타입[][] 2차원배열 = 표1row, 2row 리스트가 있는 줄(여러개 라인)
