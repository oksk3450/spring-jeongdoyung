...
public class HelloWorldApp {
	...
	public static void main(String[] args) {
		...
		sumFunc(memberVO,4);//플러스함수를 실행할때 매개변수 값을 줌.
		sumFunc(3,4);
		//메서드의 특징, 위와 같이 같은메서드명으로 로드된 매개변수가 다른 방식은 오버로드된 메서드라고 함.
		String testNull = null;
		String testEmpty = "";
		System.out.println("null출력-" + testNull + "/ empty출력-" + testEmpty);
		//System.out.println("isEmpty메서드null값출력-" + testNull.isEmpty());//에러 값이 null일순 없음
