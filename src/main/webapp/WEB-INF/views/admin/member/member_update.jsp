       ...
       <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
          <div class="col-12"><!-- 그리드시스템중 12가로칼럼중 width:100% -->
              ...
              <!-- /.card-header -->
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <!-- 폼에서 input같은 입력태그에는 name속성이 반드시 필요, 이뉴는 DB에 입력할때
                     	 값을 전송하게 되는데, 전송값을 저장하는 이름이 name이 되고, 위에서는 user_id 입니다. -->
                  </div>
                  <div class="form-group">
                    <label for="user_pw">Password</label>
                    <!-- html5에서 지원되는 유효성검사 maxlength, minlength, required, type="email" -->
                    <!-- html5을 지원하는 브라우저에서만 사용가능 그래서 jquery.validator라는 자바스크립트를 사용 -->
                  ...
                  <div class="form-group">
                    ...
                    <input value="${memberVO.user_name}" type="text" class="form-control" name="user_name" id="user-name" placeholder="이름을 입력해 주세요" required>
                        <!-- 필수입력 값은 html5에서 지원하는 유효성 검사중 required 속성을 사용해서 빈(null)체크(유효성검사)를 합니다. -->
                  </div>
                  <div class="form-group">
              ...
              <div class="card-body">
                ...
                <!-- a태그는 링크이동은 되지만, post값을 전송하지는 못함. 그래서, button태그를 사용 -->
              </div>
              <!-- 버튼영역 끝 -->
              <input name="page" type="hidden" value="${pageVO.page}" />
              </form>
              <!-- 폼 내부에 버튼이 있어야지만, 전송버튼이 작동 됩니다. -->
          </div>
        </div>
