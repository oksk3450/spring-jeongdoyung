...
<section class="contact-section"><!-- division 디비전이라는 영역표시 태그 대신 사용-->
<h1>CONTACT</h1>
<div class="container">
...
<!-- 스프링에서는 action으로 폼데이터를 전송할 위치를 지정할때, contact.html 직접 x /contact처럼 컨트롤러를 통해 o -->
...
<!-- 입력 제약조건 html5에서 지원하는 기능 type에 꼭 email라고 형식을 지정해야지만 제약조건이 작동 -->
</div>
<div class="textarea-class">
<label for="message">메시지</label>
<textarea name="message" id="message" placeholder="내용을 입력">텍스트에어리어는 밸류값이 여기에
들어가는 것이 특징입니다.</textarea>
</div>
</fieldset>
