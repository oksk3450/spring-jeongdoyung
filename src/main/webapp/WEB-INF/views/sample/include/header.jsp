...
<head><!-- 문서내용과는 관계없는 문서정보가 = 메타데이터(데이터의 데이터)가 존재 -->
<meta charset="UTF-8"><!-- 문서의 언어 인코딩설정 지금은 유니코드로 됨 -->
<!-- 반응형을 작동하기 위해서 사용하는 메타태그 뷰포트는 모니터, 모바일 액정, 프린터 -->
...
<!-- 위 부트스트랩 코어입니다. -->
<!-- span태그 자리를 차지하지 않는 영역 = 한뼘 , px 픽셀 화면에 표시되는 크기단위 -->
...
<!-- 상단 로고와 햄버거 메뉴영역 시작 -->
<h1 class="logo">
<a href="/">LOGO</a><!-- a태그는 페이지 이동역할, href헤르프 속성값에 URL을 입력해서 이동 -->
...
<!-- html5 시만텍 웹 = 의미가 있는 태그를 사용하게 해서 ai가 인식 -->
