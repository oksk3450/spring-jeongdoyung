...
$(document).ready(function(){
	$(".menu-toggle-btn").click(function(){
		...
		$(".gnb").stop().slideToggle("fast");//j쿼리 함수는 뒤에서 앞으로 해석
	});
});

/* $(document).ready(function(){//$제이쿼리 시작하다는 의미(index.html).ready(자동콜백함수실행);
	$(".menu-toggle-btn").click(function(){
		alert('햄버거 메뉴를 클릭하였습니다.');
	});
}); */
//네이티브 자바스크립트로 햄버거 메뉴 제어 하기
...
function document_ready() {
	var menu_toggle_btn = document.getElementByClassName("menu-toggle-btn");
