...
Insert into XE.TBL_BOARD (BNO,BOARD_TYPE,TITLE,WRITER,REG_DATE,UPDATE_DATE,VIEW_COUNT,REPLY_COUNT) values (105,'notice','게시물테스트','관리자',to_date('21/01/27','RR/MM/DD'),to_date('21/01/27','RR/MM/DD'),null,null);
...
Insert into XE.TBL_MEMBER (USER_ID,USER_PW,USER_NAME,EMAIL,POINT,ENABLED,LEVELS,REG_DATE,UPDATE_DATE) values ('admin_1','$2a$10$kIqR/PTloYan/MRNiEsy6uYO6OCHVmAKR4kflVKQkJ345nqTiuGeO','관리자',null,null,1,'ROLE_ADMIN',to_date('21/01/27','RR/MM/DD'),to_date('21/01/27','RR/MM/DD'));
